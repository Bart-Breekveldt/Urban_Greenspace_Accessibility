...
**Block 6 grid-parkentry pairs within euclidean threshold distance:**
...
The next line of code summarizes the amount of combinations that have been found per city.
